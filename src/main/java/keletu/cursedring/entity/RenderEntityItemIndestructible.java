...
public class RenderEntityItemIndestructible extends Render<EntityItemIndestructible> {
    private final RenderItem itemRenderer;
    private final Random random = new Random();

    public RenderEntityItemIndestructible(RenderManager p_i46167_1_, RenderItem p_i46167_2_) {
        super(p_i46167_1_);
    ...
    private int transformModelCount(EntityItemIndestructible p_transformModelCount_1_, double p_transformModelCount_2_, double p_transformModelCount_4_, double p_transformModelCount_6_, float p_transformModelCount_8_, IBakedModel p_transformModelCount_9_) {
    ...
    protected ResourceLocation getEntityTexture(EntityItemIndestructible p_getEntityTexture_1_) {
